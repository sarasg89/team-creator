...
describe("CreateFile", () => {
    ...
    it("should call fs.createFile when the file name already exists and the user chooses to override it", async () => {
        ...
        await expect(fs.writeFile).toBeCalledWith(fileName, data, expect.any(Function));
    })

    // it("should call fs.createFile when the file name already exists and the user chooses to NOT override it", () => {
