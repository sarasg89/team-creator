    ...
    <div class="col">
        <div class="card text-center text-bg-success border-success mb-3" style="width: 18rem;">
            ...
            <ul class="border-success list-group list-group-flush">
                ...
                <li class="list-group-item">Email: <a class="text-light" href="mailto:${manager.getEmail()}">${manager.getEmail()}</a></li>
        ...
        <div class="col">
            <div class="card text-center text-bg-success border-success mb-3" style="width: 18rem;">
                ...
                <ul class="border-success list-group list-group-flush">
                    ...
                    <li class="list-group-item">Email: <a class="text-light" href="mailto:${engineer.getEmail()}">${engineer.getEmail()}</a></li>
                    <li class="list-group-item">GitHub: <a href="https://github.com/${engineer.getGithub()}" class="card-link" target="_blank"> ${engineer.getGithub()}</a></li>
                </ul>
            </div>
        </div>`
        ...
        <div class="col">
            <div class="card text-center text-bg-success border-success mb-3" style="width: 18rem;">
                ...
                <ul class="border-success list-group list-group-flush">
                    ...
                    <li class="list-group-item">Email: <a class="text-light" href="mailto:${intern.getEmail()}">${intern.getEmail()}</a></li>
