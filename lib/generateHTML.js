    ...
    <div class="col">
        <div class="card text-center text-bg-success border-success mb-3" style="width: 18rem;">
            ...
            <ul class="border-success list-group list-group-flush">
                ...
                <li class="list-group-item">Email: <a class="text-success-emphasis" href="mailto:${manager.getEmail()}" target="_blank">${manager.getEmail()}</a></li>
        ...
        <div class="col">
            <div class="card text-center text-bg-success border-success mb-3" style="width: 18rem;">
                ...
                <ul class="border-success list-group list-group-flush">
                    ...
                    <li class="list-group-item">Email: <a class="text-success-emphasis" href="mailto:${engineer.getEmail()}" target="_blank">${engineer.getEmail()}</a></li>
        ...
        <div class="col">
            <div class="card text-center text-bg-success border-success mb-3" style="width: 18rem;">
                ...
                <ul class="border-success list-group list-group-flush">
                    ...
                    <li class="list-group-item">Email: <a class="text-success-emphasis" href="mailto:${intern.getEmail()}" target="_blank">${intern.getEmail()}</a></li>
